...
type
    ...
    public
        ...
        tag_excise_stamp      = 8;
        tag_auxiliaryList     = 9;
        tag_physical_label    = 10;
        tag_product_id        = 11;
        tag_barcode           = 12;
        tag_measure_unit_code = 13;
    strict private
        Fcode: UInt64;
        Fname: string;
        ...
        Fphysical_label: string;
        Fproduct_id: string;
        Fbarcode: string;
        Fmeasure_unit_code: string;

        procedure Setcode(Tag: Integer; const Value: UInt64);
        procedure Setname(Tag: Integer; const Value: string);
        ...
        procedure Setphysical_label(Tag: Integer; const Value: string);
        procedure Setproduct_id(Tag: Integer; const Value: string);
    ...
    public
        ...
        property code: UInt64 index tag_code read Fcode write Setcode;
        property name: string index tag_name read Fname write Setname;
        ...
        property physical_label: string index tag_physical_label read Fphysical_label write Setphysical_label;
        property product_id: string index tag_product_id read Fproduct_id write Setproduct_id;
    ...
    public
        ...
        tag_excise_stamp      = 7;
        tag_auxiliaryList     = 8;
        tag_physical_label    = 9;
        tag_product_id        = 10;
        tag_barcode           = 11;
        tag_measure_unit_code = 12;
    strict private
        Fname: string;
        Fsection_code: string;
        Fquantity: Cardinal;
    ...
    public
        ...
        property customer_iin_or_bin: string index tag_customer_iin_or_bin read Fcustomer_iin_or_bin write Setcustomer_iin_or_bin;
    end;
    ...
    strict private
        ...
        procedure Setprinted_document_number_old(Tag: Integer; const Value: string);
        ...
        procedure Setprinted_document_number(Tag: Integer; const Value: UInt64);
    strict protected
        function LoadSingleFieldFromBuf(ProtoBuf: TProtoBufInput; FieldNumber: Integer; WireType: Integer): Boolean; override;
        procedure SaveFieldsToBuf(ProtoBuf: TProtoBufOutput); override;
    public
        ...
        property printed_document_number_old: string index tag_printed_document_number_old read Fprinted_document_number_old write Setprinted_document_number_old;
        ...
        property printed_document_number: UInt64 index tag_printed_document_number read Fprinted_document_number write Setprinted_document_number;
    end;
...
begin
    ...
    try
        if FieldHasValue[tag_tax_type] then
            ProtoBuf.writeInt32(tag_tax_type, Integer(Ftax_type));
        if FieldHasValue[tag_taxation_type] then
            ProtoBuf.writeInt32(tag_taxation_type, Integer(Ftaxation_type));
...
begin
    for var item in taxesList do
        item.Free;
    for var item in auxiliaryList do
        item.Free;
    Fsum.Free;
    inherited;
end;
    ...
    try
        case FieldNumber of
            ...
            tag_auxiliaryList:
                AddFromBufL(ProtoBuf, FieldNumber, auxiliaryList);
            tag_physical_label:
                physical_label := ProtoBuf.readString;
            tag_product_id:
                product_id := ProtoBuf.readString;
            tag_barcode:
...
begin
    ...
    try
        if FieldHasValue[tag_code] then
            ProtoBuf.writeInt64(tag_code, Fcode);
        if FieldHasValue[tag_name] then
            ProtoBuf.writeString(tag_name, Fname);
        ...
        if FieldHasValue[tag_auxiliaryList] then
            SaveToBufL(ProtoBuf, tag_auxiliaryList, auxiliaryList);
        if FieldHasValue[tag_physical_label] then
            ProtoBuf.writeString(tag_physical_label, Fphysical_label);
        if FieldHasValue[tag_product_id] then
            ProtoBuf.writeString(tag_product_id, Fproduct_id);
...
procedure TCommodity.Setcode(Tag: Integer; const Value: UInt64);
begin
    Fcode := Value;
    FieldHasValue[Tag] := True;
end;
...
procedure TCommodity.Setphysical_label(Tag: Integer; const Value: string);
begin
    Fphysical_label := Value;
    FieldHasValue[Tag] := True;
end;


procedure TCommodity.Setproduct_id(Tag: Integer; const Value: string);
begin
    Fproduct_id := Value;
    FieldHasValue[Tag] := True;
end;
...
procedure TCommodity.Setbarcode(Tag: Integer; const Value: string);
begin
    Fbarcode := Value;
    FieldHasValue[Tag] := True;
end;
...
procedure TCommodity.Setmeasure_unit_code(Tag: Integer; const Value: string);
begin
...
procedure TStornoCommodity.Setphysical_label(Tag: Integer; const Value: string);
begin
    Fphysical_label := Value;
    FieldHasValue[Tag] := True;
end;
...
procedure TStornoCommodity.Setproduct_id(Tag: Integer; const Value: string);
begin
    Fproduct_id := Value;
    FieldHasValue[Tag] := True;
end;
...
procedure TStornoCommodity.Setbarcode(Tag: Integer; const Value: string);
begin
    Fbarcode := Value;
    FieldHasValue[Tag] := True;
end;
...
procedure TStornoCommodity.Setmeasure_unit_code(Tag: Integer; const Value: string);
begin
    Fmeasure_unit_code := Value;
    FieldHasValue[Tag] := True;
end;
...
begin
    ...
    case FieldNumber of
        ...
        tag_auxiliaryList:
            AddFromBufL(ProtoBuf, FieldNumber, auxiliaryList);
        tag_customer_iin_or_bin:
            customer_iin_or_bin := ProtoBuf.readString;
        else
            Result := False;
    end;
end;
...
begin
    ...
    if FieldHasValue[tag_auxiliaryList] then
        SaveToBufL(ProtoBuf, tag_auxiliaryList, auxiliaryList);
    if FieldHasValue[tag_customer_iin_or_bin] then
        ProtoBuf.writeString(tag_customer_iin_or_bin, Fcustomer_iin_or_bin);
end;
...
procedure TExtensionOptions.Setcustomer_iin_or_bin(Tag: Integer; const Value: string);
begin
    Fcustomer_iin_or_bin := Value;
    FieldHasValue[Tag] := True;
end;
...
begin
    for var item in itemsList do
        item.Free;
    for var item in taxesList do
        item.Free;
    for var item in paymentsList do
        item.Free;
    for var item in ad_infosList do
        item.Free;
    Fdate_time.Free;
    Foperator.Free;
    Fdomain.Free;
...
begin
    ...
    try
        case FieldNumber of
            ...
            tag_printed_document_number_old:
                printed_document_number_old := ProtoBuf.readString;
            tag_printed_ticket:
            ...
            tag_printed_document_number:
                printed_document_number := ProtoBuf.readInt64;
            else
                Result := False;
        end;
    finally
...
begin
    ...
    try
        ...
        if FieldHasValue[tag_printed_document_number_old] then
            ProtoBuf.writeString(tag_printed_document_number_old, Fprinted_document_number_old);
        ...
        if FieldHasValue[tag_printed_document_number] then
            ProtoBuf.writeInt64(tag_printed_document_number, Fprinted_document_number);
    finally
        tmpBuf.Free
    end;
end;
...
procedure TTicketRequest.Setprinted_document_number_old(Tag: Integer; const Value: string);
begin
    Fprinted_document_number_old := Value;
    FieldHasValue[Tag] := True;
end;
...
procedure TTicketRequest.Setprinted_document_number(Tag: Integer; const Value: UInt64);
begin
