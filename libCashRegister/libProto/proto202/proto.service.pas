...
type
    ...
    public const
        ...
        tag_marker                   = 9;
        tag_software_information_old = 10;
    ...
    strict private
        ...
        Fsoftware_information_old: TBytes;
        ...
        procedure Setsoftware_information_old(Tag: Integer; const Value: TBytes);
    strict protected
        function LoadSingleFieldFromBuf(ProtoBuf: TProtoBufInput; FieldNumber: Integer; WireType: Integer): Boolean; override;
        procedure SaveFieldsToBuf(ProtoBuf: TProtoBufOutput); override;
    public
        ...
        property software_information_old: TBytes index tag_software_information_old read Fsoftware_information_old write Setsoftware_information_old;
    ...
    TLastDocumentInfo = class(TAbstractProtoBufClass)
    public
         const
        tag_fr_shift_number         = 1;
        tag_printed_document_number = 2;
    strict private
    ...
    public const
        ...
        tag_last_document_info = 4;
        tag_auxiliaryList      = 30;
    strict private
// Fticket_adsList: TList<TTicketAd>;
        Freg_info: TRegInfo;
        Fbinded_taxation: TBindedTaxation;
        Flast_document_info: TLastDocumentInfo;
        FauxiliaryList: TProtoBufClassList<TKeyValuePair>;
...
begin
    ...
    RegisterRequiredField(tag_get_reg_info);
    get_reg_info := True;
end;
...
begin
    ...
    try
        case FieldNumber of
            ...
            tag_software_information_old:
                software_information_old := ProtoBuf.readBytes;
...
begin
    ...
    try
        ...
        if FieldHasValue[tag_software_information_old] then
            ProtoBuf.writeBytes(tag_software_information_old, Fsoftware_information_old);
...
procedure TServiceRequest.Setsoftware_information_old(Tag: Integer; const Value: TBytes);
begin
    Fsoftware_information_old := Value;
    FieldHasValue[Tag] := True;
end;
...
constructor TLastDocumentInfo.Create;
begin
    inherited;
    RegisterRequiredField(tag_fr_shift_number);
// RegisterRequiredField(tag_printed_document_number);
end;


destructor TLastDocumentInfo.Destroy;
begin
    inherited;
end;


function TLastDocumentInfo.LoadSingleFieldFromBuf(ProtoBuf: TProtoBufInput; FieldNumber: Integer; WireType: Integer): Boolean;
begin
    Result := inherited;
    if Result then
        Exit;
...
procedure TLastDocumentInfo.SaveFieldsToBuf(ProtoBuf: TProtoBufOutput);
begin
    inherited;
...
procedure TLastDocumentInfo.Setfr_shift_number(Tag: Integer; const Value: Cardinal);
begin
...
procedure TLastDocumentInfo.Setprinted_document_number(Tag: Integer; const Value: UInt64);
begin
...
// Fticket_adsList := TProtoBufClassList<TTicketAd>.Create;
    ...
    Flast_document_info := TLastDocumentInfo.Create;
    FauxiliaryList := TProtoBufClassList<TKeyValuePair>.Create;
end;
...
begin
    for var item in ticket_adsList do
        item.Free;
    Freg_info.Free;
    Fbinded_taxation.Free;
    Flast_document_info.Free;
    FauxiliaryList.Free;
    inherited;
end;
...
begin
    ...
    try
        case FieldNumber of
            tag_ticket_adsList:
                AddFromBufL(ProtoBuf, FieldNumber, ticket_adsList);
            tag_reg_info:
                begin
                    tmpBuf := ProtoBuf.ReadSubProtoBufInput;
                    Freg_info.LoadFromBuf(tmpBuf);
            ...
            tag_last_document_info:
                begin
                    tmpBuf := ProtoBuf.ReadSubProtoBufInput;
                    Flast_document_info.LoadFromBuf(tmpBuf);
                end;
            tag_auxiliaryList:
                FauxiliaryList.AddFromBuf(ProtoBuf, FieldNumber);
            else
...
begin
    ...
    try
        if FieldHasValue[tag_ticket_adsList] then
            SaveToBufL(ProtoBuf, tag_ticket_adsList, ticket_adsList);
        if FieldHasValue[tag_reg_info] then
            SaveMessageFieldToBuf(Freg_info, tag_reg_info, tmpBuf, ProtoBuf);
        if FieldHasValue[tag_binded_taxation] then
            SaveMessageFieldToBuf(Fbinded_taxation, tag_binded_taxation, tmpBuf, ProtoBuf);
        if FieldHasValue[tag_last_document_info] then
            SaveMessageFieldToBuf(Flast_document_info, tag_last_document_info, tmpBuf, ProtoBuf);
        if FieldHasValue[tag_auxiliaryList] then
            FauxiliaryList.SaveToBuf(ProtoBuf, tag_auxiliaryList);
    finally
        tmpBuf.Free
