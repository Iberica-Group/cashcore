...
procedure TAbstractProtoBufClass.AddFieldState(Tag: Integer; AFieldState: TFieldState);
begin
{$IFDEF FPC}
...
procedure TAbstractProtoBufClass.ClearFieldState(Tag: Integer; AFieldState: TFieldState);
begin
{$IFDEF FPC}
...
procedure TAbstractProtoBufClass.SaveMessageFieldToBuf(AField: TAbstractProtoBufClass; AFieldNumber: Integer; AFieldProtoBufOutput, AMainProtoBufOutput: TProtoBufOutput);
begin
...
procedure TAbstractProtoBufClass.SetFieldHasValue(Tag: Integer; const Value: Boolean);
begin
    if Value then
        AddFieldState(Tag, [fsHasValue])
    else
