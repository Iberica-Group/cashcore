...
type
  ...
  public
    ...
    constructor Create(buf: PByte; len: Integer; ACopyBuffer: Boolean = False); overload;
    ...
    procedure LoadFromBuf(buf: PByte; len: Integer; ACopyBuffer: Boolean = False);
...
constructor TProtoBufInput.Create(buf: PByte; len: integer; ACopyBuffer: boolean);
begin
  Create;
...
procedure TProtoBufInput.LoadFromBuf(buf: PByte; len: Integer;
  ACopyBuffer: Boolean);
begin
  FreeBuffer;
